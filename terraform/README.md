...
| Name | Type |
|------|------|
| [juju_application.flog](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/application) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_app_name"></a> [app\_name](#input\_app\_name) | n/a | `string` | `"flog"` | no |
| <a name="input_channel"></a> [channel](#input\_channel) | n/a | `string` | `"latest/edge"` | no |
| <a name="input_charm_name"></a> [charm\_name](#input\_charm\_name) | n/a | `string` | `"flog-k8s"` | no |
